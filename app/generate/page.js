    ...
    return (
        <Container maxWidth="md" disableGutters>
            <Box sx={{ mt: 6, mb: 8, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <Typography variant="h3" sx={{ fontWeight: 'bold', color: '#333333', mb: 4 }}>
                    Generate Flashcards
                </Typography>
                <Paper sx={{ p: 4, width: '100%', borderRadius: 2, boxShadow: 1 }}>
                    <TextField
                        value={text}
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogActions>
                    <Button onClick={handleClose} sx={{ color: '#333333' }}>Cancel</Button>
                    <Button onClick={saveFlashcards} variant="contained" color="secondary">
                        Save
                    </Button>
                </DialogActions>
            </Dialog>
